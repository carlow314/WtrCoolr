          ...
          <div className="container logandsign">
            <div className="row loginRow">
              <Switch>
                ...
                <PrivateRoute authed={this.state.authed} path='/dashboard' user={this.state.user} component={()=><CommentBox  url='https:/officechitchat.com.herokuapp.com/api/comments'
 pollInterval={2000}/>}/>
