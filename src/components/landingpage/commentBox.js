			...
			<div className="container commentformBox">
				<div style={style.commentBox}>
					...
					<div className="allcomments">
						<div className="commentImages">
							<p>
								Myself and two of my coworkers were walking out of the office to get lunch. S, has a
								fairly large chest and M is half japanese and half irish. M, lacks any and all filters -{' '}
							</p>

							<p>
								M: “So, S, have your boobs always been this big? (He asks this not in a sexual way, but
								as though he was legitimately curious. Like the thought literally just crossed his mind
								even though we have all been working together for awhile now).”
							</p>

							<p>
								S: “Uh, Yes, ALWAYS. Shoot, I’d be happy with a size B. I’ve had enough of this back
								pain bs” (She nods her head, happy with the thought).
							</p>
							...
							<p>
								{' '}
								Oh HR …. Not really, but this is a pretty indicative of conversations in the office….
								Entertaining to overhear, but so politically incorrect.
							</p>
							<LikeButton />
						</div>
					</div>
					...
					<div className="allcomments">
						<div className="commentImages">
							...
							<p>
								M: Yes, if I had one I would bring it in so that you could try it. I think that everyone
								should try it once (please don’t bring in a shock collar, M)
							</p>
							<LikeButton />
						</div>
					</div>
					...
					<div className="allcomments">
						<div className="commentImages">
							<p>
								(I am a technician. I am fixing a blood pressure testing machine at the local
								supermarket when a man comes up wanting to have his blood pressure checked.)
							</p>

							<p>Me: “Sorry, I’m not quite done here. I’ll have it up and running in a few minutes.” </p>

							<p>
								Customer: “You aren’t really fixing that; you’re just stealing the electricity to power
								your laptop!”
							</p>
