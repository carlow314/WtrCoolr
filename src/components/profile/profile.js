...
class Profile extends Component {
	handleEmailChange = e => {
		e.preventDefault();
		changeEmail(this.email.value).catch(error => {
			console.log(error);
		});
	};
	...
	handlePwChange = e => {
		e.preventDefault();
		changePassword(this.pw.value).catch(error => {
			console.log(error);
		});
	};
				...
				<div className="row profile">
					...
					<div className="col-lg-10 allInfo">
						...
						<form className="form-inline" onSubmit={this.handleEmailChange}>
							...
							<button type="submit" className="btn btn-primary changeEmail">
								Change Email
							</button>
						</form>
						...
						<div className="row favposts">
							...
							<div className="mycard">
								<div className="card post">
									<div className="card-body">Oh my gosh I freaking love this post!</div>
									<button type="button" class="btn btn-primary btn-sm favDelete">
						...
						<div className="row myposts">
							...
							<div className="mycard">
								<div className="card post">
									...
									<div className="row">
										<button type="button" class="btn btn-primary btn-sm myPosts">
											Delete
										</button>
										<button type="button" class="btn btn-primary btn-sm myPosts">
											Edit
									...
									<form>
										<div class="form-row">
											<div class="col-auto">
												<div class="form-check mb-2 mb-sm-0">
													<label class="form-check-label">
														<input class="form-check-input" type="checkbox" /> Receive
														Emails
													</label>
												</div>
											</div>
											<div class="col-auto">
												<div class="form-check mb-2 mb-sm-0">
													<label class="form-check-label">
														<input class="form-check-input" type="checkbox" /> Notify me
														when my posts are liked
													</label>
												</div>
											</div>
											<div class="col-auto">
												<div class="form-check mb-2 mb-sm-0">
													<label class="form-check-label">
														<input class="form-check-input" type="checkbox" /> Update me for
														new posts
													</label>
												</div>
											</div>
											<div class="col-auto">
												<button type="submit" class="btn btn-primary notificationButtons">
													Submit
												</button>
											</div>
										</div>
